            ...
            <div className='col-12 col-lg-7 order-2 order-lg-1'>
                <div className='part-1'>
                  ...
                  <div className="social-links">
                      ...
                      <a href="https://www.linkedin.com/in/rohith-kankipati-21b51519b/" target="_blank" rel="noopener noreferrer">
                        <FontAwesomeIcon icon={faLinkedin} />
                      </a>
                      <a href="https://x.com/rohith_4743" target="_blank" rel="noopener noreferrer">
                        <FontAwesomeIcon icon={faTwitter} />
                      </a>
                      <a href="mailto:kankipatirohith4@gmail.com" target="_blank" rel="noopener noreferrer">
